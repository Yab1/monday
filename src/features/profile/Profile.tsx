...
import { Header, Settings, Information, Invites, Projects } from "./widgets";
...
function Profile() {
  return (
    <Fragment>
      <div
        className={`relative mt-8 h-72 w-full overflow-hidden rounded-xl bg-[url(${bgLink})] bg-cover	bg-center`}
      >
      ...
      <Card className="mx-3 mb-6 -mt-16 lg:mx-4">
        <CardBody className="p-4">
          <Header />
          <div className="grid gap-12 px-4 mb-12 gird-cols-1 lg:grid-cols-3 xl:grid-cols-3">
            <Settings />
            <Information />
            <Invites />
          </div>
